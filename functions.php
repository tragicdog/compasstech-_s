<?php
/**
 * CompassTech functions and definitions
 *
 * @package CompassTech
 */

if ( ! function_exists( 'compasstech_setup' ) ) :
/**
 ...
 */
function compasstech_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on CompassTech, use a find and replace
	 * to change 'compasstech' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'compasstech', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'compasstech' ),
	) );
 ...
 */
function compasstech_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'compasstech' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'compasstech_widgets_init' );
...
function compasstech_scripts() {
	wp_enqueue_style( 'compasstech-style', get_stylesheet_uri() );
        ...
        wp_enqueue_style( 'compasstech-content-sidebar', get_template_directory_uri() . '/layouts/content-sidebar.css' );
...
add_action( 'wp_enqueue_scripts', 'compasstech_scripts' );
